        ...
        <div className="full-page-container">
            ...
            <div className='content-section info-content-section'>
                ...
                <h2 className="info-subtitle">引用</h2>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="https://www.sangiin.go.jp/japanese/touhyoulist/touhyoulist.html">参議院ホームページ</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="https://kokkai.ndl.go.jp/api.html">国会会議録検索システム</a>
                ...
                <div className='info-content'>
                    ...
                    <p>当サイトにて公開されている内容に関して、編集著作権を含む権利は当サイト管理者に帰属します。よって、当サイトの内容を管理者の承諾を得ずに使用することは禁止します。</p>
