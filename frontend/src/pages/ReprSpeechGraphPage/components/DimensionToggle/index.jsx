...
function DimensionToggle({ selectedDimension, setSelectedDimension }) {
	...
	console.log(isMobile);
 	const buttonClass = isMobile ? ' h-1/2 rounded-md font-bold m-0 px-3 ' : 'w-100 border-2 m-2 pt-1 pb-1 pr-5 pl-5 text-center font-bold rounded-md';
	return (
	<div className={`h-full flex justify-center items-center flex-wrap overflow-y-scroll ${isMobile ? 'flex-col w-auto' : 'w-full'}`}>
