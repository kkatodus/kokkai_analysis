...
export default function CardItem(props) {
  ...
  if (link) {
    return (
      <WebViewLink
        to={link}
        className={`w-[250px] max-h-[300px] p-2 m-2 flex flex-col items-center rounded-xl ${
          colors.primary
        } transition hover:scale-105 cursor-pointer overflow-hidden ${
          isMobile ? 'w-[150px] max-h-[200px]' : ''
        }`}
      >
