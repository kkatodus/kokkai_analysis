...
new_json = {"meetings":None}
new_meeting_array = []
output_dir = "..\\data_sangiin_test\\"
...
for filename in os.listdir(target_dir):
    ...
    new_meeting_array.append(target_file_json)
new_json["meetings"] = new_meeting_array
frw.write_json(new_json, output_file_path)