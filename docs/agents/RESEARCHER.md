...
LaTeX sources + `references.bib` in each. Published work also on [arXiv (2025)](https://arxiv.org/abs/2505.07118).
...
1. Read [DATA-LAYOUT.md](./DATA-LAYOUT.md) for input data paths (`repr_speeches_id_organized/`, `data_repr_speeches/`, `idea_summaries/`)
